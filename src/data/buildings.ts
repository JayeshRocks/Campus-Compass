...
export const buildings: Building[] = [
  ...
  // Sports Grounds
  {
    ...
    category: "sports",
    description: "Main cricket ground with circular turf pitches and a 400m jogging track loop.",
    latitude: 13.1255,
    longitude: 77.5925,
    busyStatus: "Moderate",
    busyColor: "bg-yellow-500",
  ...
  },
  {
    ...
    name: "Football Field",
    category: "sports",
    description: "Standard size turf football pitch hosting inter-college soccer tournaments.",
    latitude: 13.1242,
    longitude: 77.5920,
    busyStatus: "Moderate",
    busyColor: "bg-yellow-500",
