  ...
  return (
    <div className="fixed bottom-[100px] md:bottom-[24px] right-[24px] z-[80] flex flex-col gap-3 transition-all duration-300">
      ...
      <button
        ...
        className="w-12 h-12 glass-panel rounded-full shadow-lg ghost-border flex items-center justify-center text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-surface-container-high transition-colors cursor-pointer active:scale-95 mx-auto group"
      ...
      {/* Zoom Controls */}
      <div className="glass-panel rounded-full shadow-lg ghost-border flex flex-col overflow-hidden w-12 mx-auto">
        <button
          onClick={onZoomIn}
